...
public:
    ...
    */
    ...
    //! \copydoc shared_library::shared_library(const std::experimental::filesystem::path& lib_path, load_mode::type mode = load_mode::default_mode)
    smart_library(const std::experimental::filesystem::path& lib_path, load_mode::type mode = load_mode::default_mode) {
        _lib.load(lib_path, mode);
        _storage.load(lib_path);
    }

    //! \copydoc shared_library::shared_library(const std::experimental::filesystem::path& lib_path, boost::dll::fs::error_code& ec, load_mode::type mode = load_mode::default_mode)
    smart_library(const std::experimental::filesystem::path& lib_path, boost::dll::fs::error_code& ec, load_mode::type mode = load_mode::default_mode) {
        load(lib_path, mode, ec);
    }

    //! \copydoc shared_library::shared_library(const std::experimental::filesystem::path& lib_path, load_mode::type mode, boost::dll::fs::error_code& ec)
    smart_library(const std::experimental::filesystem::path& lib_path, load_mode::type mode, boost::dll::fs::error_code& ec) {
        load(lib_path, mode, ec);
    }
    /*!
    ...
    */
    ...
    //! \copydoc shared_library::load(const std::experimental::filesystem::path& lib_path, load_mode::type mode = load_mode::default_mode)
    void load(const std::experimental::filesystem::path& lib_path, load_mode::type mode = load_mode::default_mode) {
    ...
    //! \copydoc shared_library::load(const std::experimental::filesystem::path& lib_path, boost::dll::fs::error_code& ec, load_mode::type mode = load_mode::default_mode)
    void load(const std::experimental::filesystem::path& lib_path, boost::dll::fs::error_code& ec, load_mode::type mode = load_mode::default_mode) {
        ec.clear();
        _storage.load(lib_path);
        _lib.load(lib_path, mode, ec);
    }

    //! \copydoc shared_library::load(const std::experimental::filesystem::path& lib_path, load_mode::type mode, boost::dll::fs::error_code& ec)
    void load(const std::experimental::filesystem::path& lib_path, load_mode::type mode, boost::dll::fs::error_code& ec) {
        ec.clear();
        _storage.load(lib_path);
        _lib.load(lib_path, mode, ec);
    }
