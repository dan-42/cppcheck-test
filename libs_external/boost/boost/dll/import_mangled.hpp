...
template <class ...Args>
BOOST_DLL_MANGLED_IMPORT_RESULT_TYPE import_mangled(const std::experimental::filesystem::path& lib, const char* name,
...
template <class ...Args>
BOOST_DLL_MANGLED_IMPORT_RESULT_TYPE import_mangled(const std::experimental::filesystem::path& lib, const std::string& name,
    load_mode::type mode = load_mode::default_mode)
{
