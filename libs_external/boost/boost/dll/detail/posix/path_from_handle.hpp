...
namespace boost { namespace dll { namespace detail {
    ...
    inline std::experimental::filesystem::path path_from_handle(void* handle, boost::dll::fs::error_code &ec) {
...
namespace boost { namespace dll { namespace detail {
    ...
    inline std::experimental::filesystem::path path_from_handle(const void* handle, boost::dll::fs::error_code &ec) {
        ...
        std::experimental::filesystem::path ret = boost::dll::symbol_location_ptr(si->base, ec);
...
namespace boost { namespace dll { namespace detail {
    ...
    inline std::experimental::filesystem::path path_from_handle(void* handle, boost::dll::fs::error_code &ec) {
        ...
        return std::experimental::filesystem::path(link_map->l_name);
    }
