...
namespace boost { namespace dll { namespace detail {
    inline std::experimental::filesystem::path program_location_impl(boost::dll::fs::error_code &ec) {
        ...
        std::experimental::filesystem::path ret(p);
        delete[] p;
        return ret;
    }
...
namespace boost { namespace dll { namespace detail {
    inline std::experimental::filesystem::path program_location_impl(boost::dll::fs::error_code& ec) {
        ...
        return std::experimental::filesystem::path(getexecname());
    }
}}} // namespace boost::dll::detail
...
namespace boost { namespace dll { namespace detail {
    inline std::experimental::filesystem::path program_location_impl(boost::dll::fs::error_code &ec) {
        ...
        return std::experimental::filesystem::path(s);
    }
}}} // namespace boost::dll::detail
...
namespace boost { namespace dll { namespace detail {
    inline std::experimental::filesystem::path program_location_impl(boost::dll::fs::error_code &ec) {
        ...
        return boost::dll::fs::read_symlink("/proc/self/exe", ec).string();   // Linux specific
    }
}}} // namespace boost::dll::detail
