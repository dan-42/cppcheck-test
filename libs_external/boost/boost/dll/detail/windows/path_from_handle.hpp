...
namespace boost { namespace dll { namespace detail {
    ...
    inline std::experimental::filesystem::path path_from_handle(boost::winapi::HMODULE_ handle, boost::dll::fs::error_code &ec) {
        ...
        if (!ec) {
            return std::experimental::filesystem::path(path_hldr);
        }
