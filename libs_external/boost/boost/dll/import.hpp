...
*/
template <class T>
BOOST_DLL_IMPORT_RESULT_TYPE import(const std::experimental::filesystem::path& lib, const char* name,
...
//! \overload boost::dll::import(const std::experimental::filesystem::path& lib, const char* name, load_mode::type mode)
template <class T>
BOOST_DLL_IMPORT_RESULT_TYPE import(const std::experimental::filesystem::path& lib, const std::string& name,
    load_mode::type mode = load_mode::default_mode)
{
...
*/
template <class T>
BOOST_DLL_IMPORT_RESULT_TYPE import_alias(const std::experimental::filesystem::path& lib, const char* name,
    load_mode::type mode = load_mode::default_mode)
{
    typedef typename boost::dll::detail::import_type<T>::base_type type;
...
//! \overload boost::dll::import_alias(const std::experimental::filesystem::path& lib, const char* name, load_mode::type mode)
template <class T>
BOOST_DLL_IMPORT_RESULT_TYPE import_alias(const std::experimental::filesystem::path& lib, const std::string& name,
    load_mode::type mode = load_mode::default_mode)
{
