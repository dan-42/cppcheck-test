...
\code{.cpp}
std::filesystem::path log    = "my_log_file.txt";
std::filesystem::path input  = "input.txt";
std::filesystem::path output = "output.txt";
...
struct std_in_
{
    ...
    api::file_in operator=(const std::filesystem::path &p) const {return p;}
...
struct std_out_
{
    ...
    api::file_out<p1,p2> operator=(const std::filesystem::path &p) const {return api::file_out<p1,p2>(p);}
